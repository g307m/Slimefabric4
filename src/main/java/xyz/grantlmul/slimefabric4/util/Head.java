...
public enum Head {
    ...
    TAPE_MEASURE("180d5c43a6cf5bb7769fd0c8240e1e70d2ae38ef9d78a1db401aca6a2cb36f65");
    ...
    //give @p minecraft:player_head{display:{Name:"{\"text\":\"\"}"},SkullOwner:{Id:[I;472946615,279267465,-1407216918,-1245642985],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMmU1ZmJjMDA5NWRiZjE3ZTEyY2RlNWVjYWQ1ZTE2YjAwYTIxNTQzN2VkN2E5MzRjNmJlMmVkMTA4MjA5ODc3OSJ9fX0="}]}}} 1
    public ItemStack getHead() {
        ...
        Gson gson = new GsonBuilder()
                .create();
        // make json string
        // {"textures":{"SKIN":{"url":"http://textures.minecraft.net/texture/2e5fbc0095dbf17e12cde5ecad5e16b00a215437ed7a934c6be2ed1082098779"}}}
        String json = gson.toJson(new Object(){
            Object textures = new Object(){
                Object SKIN = new Object(){
                    String url = textureUrl;
                };
            };
        });
        // base64ify
        String json64 = Base64.getEncoder().encodeToString(json.getBytes(StandardCharsets.UTF_8));
        ...
        // SkullOwner.Properties.textures[0]
        NbtCompound value = new NbtCompound();
        // SkullOwner.Properties.textures[0].Value
        value.putString("Value", json64);
        textures.add(value);
        properties.put("textures", textures);
        skullOwner.put("Properties", properties);

        // put head data
        head.setSubNbt("SkullOwner", skullOwner);
        // return head with data
        return head;
    }
}